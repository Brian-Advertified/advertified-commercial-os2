...
class InventoryProductTypes(StrEnum):
    ...
    PAID_SEARCH_AD = "PAID_SEARCH_AD"
    PROGRAMMATIC_DISPLAY_AD = "PROGRAMMATIC_DISPLAY_AD"
    PERFORMANCE_MAX_CAMPAIGN = "PERFORMANCE_MAX_CAMPAIGN"
    ONLINE_VIDEO_AD = "ONLINE_VIDEO_AD"
    PAID_SOCIAL_AD = "PAID_SOCIAL_AD"

class DigitalAdPlatforms(StrEnum):
    GOOGLE_ADS = "GOOGLE_ADS"
    YOUTUBE_ADS = "YOUTUBE_ADS"
    META_ADS = "META_ADS"

class DigitalBuyingModels(StrEnum):
    AUCTION = "AUCTION"

class DigitalAdFormats(StrEnum):
...
class PlanningPolicies(StrEnum):
    ...
    INVENTORY_SUITABILITY_OOH_V2 = "INVENTORY_SUITABILITY_OOH_V2"
