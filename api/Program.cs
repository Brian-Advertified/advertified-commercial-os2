...
builder.Services.AddScoped<IInventoryReader, InventoryReader>(); builder.Services.AddScoped<IInventoryCommands, InventoryCommands>();
builder.Services.AddInventoryResearch();
