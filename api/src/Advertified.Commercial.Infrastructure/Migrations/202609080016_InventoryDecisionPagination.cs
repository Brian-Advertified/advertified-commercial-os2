...
[Migration("202609080016_InventoryDecisionPagination")]
public sealed class InventoryDecisionPagination : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder) => migrationBuilder.Sql("""
        DROP FUNCTION commercial.read_inventory_decisions(uuid, uuid);
    ...
    protected override void Down(MigrationBuilder migrationBuilder) =>
        throw new NotSupportedException("Inventory decision pagination is forward-only.");
}
