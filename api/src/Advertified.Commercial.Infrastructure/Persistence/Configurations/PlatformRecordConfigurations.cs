...
public sealed class IdempotencyRecordConfiguration
    : IEntityTypeConfiguration<IdempotencyRecordRow>
{
    public void Configure(EntityTypeBuilder<IdempotencyRecordRow> builder)
    {
        ...
        builder.Property(item => item.OutcomeJson)
        ...
        builder.HasOne<Domain.Commercial.Tenant>()
            .WithMany()
...
public sealed class AuditEventConfiguration : IEntityTypeConfiguration<AuditEventRow>
{
    public void Configure(EntityTypeBuilder<AuditEventRow> builder)
    {
        ...
        {
            table.HasCheckConstraint("ck_audit_events_resource_version", "resource_version > 0");
        });
        ...
        builder.Property(item => item.TenantId)
            .HasColumnName("tenant_id")
            .HasConversion(value => value.Value, value => new TenantId(value));
        builder.Property(item => item.ActorId)
...
public sealed class OutboxMessageConfiguration : IEntityTypeConfiguration<OutboxMessageRow>
{
    public void Configure(EntityTypeBuilder<OutboxMessageRow> builder)
    {
        ...
        builder.Property(item => item.TenantId)
            .HasColumnName("tenant_id")
            .HasConversion(value => value.Value, value => new TenantId(value));
        builder.Property(item => item.CausationId)
        ...
        builder.Property(item => item.AggregateType)
            .HasColumnName("aggregate_type_code")
            .HasMaxLength(100)
            .HasConversion(value => value.Value, value => new ResourceTypeCode(value));
        ...
        builder.Property(item => item.TransportReference)
            .HasColumnName("transport_reference")
            .HasMaxLength(300);
        ...
        builder.HasIndex(item => item.ClaimToken)
            .IsUnique()
