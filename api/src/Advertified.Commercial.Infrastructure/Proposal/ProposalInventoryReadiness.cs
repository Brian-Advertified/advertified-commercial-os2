...
public sealed class ProposalInventoryReadiness(ProposalRecordStore store, PlanningRecordStore planningStore)
{
    internal async Task EnsurePlanInputsCurrentAsync(
        TenantId tenantId,
    ...
    internal async Task EnsureProposalPlansCurrentAsync(
        TenantId tenantId,
