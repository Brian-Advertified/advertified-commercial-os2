...
export const investmentBands = [
  {
    ...
    mediaExamples: ['Radio', 'Digital', 'Social media', 'Local outdoor advertising'],
  },
  {
    name: 'Boost',
    ...
    mediaExamples: ['Radio', 'Outdoor advertising', 'Digital', 'Influencer'],
  },
  {
    name: 'Scale',
    ...
    mediaExamples: ['Television', 'Radio', 'Outdoor advertising', 'Digital'],
  },
  {
    name: 'Dominance',
    ...
    mediaExamples: ['Television', 'Radio', 'Outdoor advertising', 'Print', 'Digital', 'Creators'],
  },
] as const;
