...
export const emailAutomationRunSchema = z.object({
  ...
  deliveryProviderCode: z.string().nullable(),
  deliveryProviderId: z.string().nullable(),
  deliveryRequestedAtUtc: z.iso.datetime({ offset: true }).nullable(),
  deliveryAcceptedAtUtc: z.iso.datetime({ offset: true }).nullable(),
