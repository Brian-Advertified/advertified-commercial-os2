...
export const briefVersionSchema = z.object({
  ...
  feesMinor: z.number().int().nonnegative().nullable(), mediaRequirements: z.array(z.string()),
  constraints: z.array(z.string()), measurement: z.array(z.string()), facts: z.array(z.string()),
