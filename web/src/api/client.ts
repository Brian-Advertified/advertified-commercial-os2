...
const safeMessages: Readonly<Record<string, string>> = {
  ...
  INVALID_API_RESPONSE: 'Advertified received an unexpected response. Try the action again; the screen will reload current data automatically.',
  ...
  CSRF_VALIDATION_FAILED: 'Advertified could not verify this action. The screen will recover its current state automatically; try the action again.',
  ...
  VERSION_CONFLICT: 'This information changed while you were working. Advertified has loaded the latest state; review it and continue.',
