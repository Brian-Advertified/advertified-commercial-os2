...
| 7\. Planning                 | Shared STP, media mix, eligibility, shortlist, benchmark, supply/forecast and MediaPlan approval                | E2E-03 reaches approved STP and plan; stale input test passes                   | 5-6            |
| 8\. Proposal                 | Distinct options, narrative, critic, totals, approval, branded DOCX/PDF and delivery                            | E2E-03/E2E-07 pass and AI cost recorded                                        | 7              |
| 9\. OOH-only automation      | Immutable OOH-only mode on the canonical STP/planning spine, dedicated inbound mailbox, automated proposal/PDF delivery and exactly-once recovery | E2E-04 proves OOH/DOOH-only selection, zero-touch ready path, no-send exception path and complete restart for expanded scope | 6-8            |
...
| OOH-only campaign          | Uses the same evidence → approved Brief → STP → media mix → verified supply/forecast → approved plan → proposal sequence as every campaign. Its immutable mode permits only OOH/DOOH. A configured inbound mailbox may complete and send a ready proposal with no per-message user action; incomplete, unsafe or non-OOH input sends nothing. | Sections 7, 19, 22 and E2E-04 |
| Full multi-channel          | Evidence -\> strategy/critic -\> approved Brief -\> STP -\> media mix -\> verified supply/forecast -\> approved plan -\> proposal. Radio, TV, digital, OOH, print, social and influencer roles require business rationale; no channel is included because of a meeting location or familiarity. | Sections 7, 19, 22 and E2E-03                                                                                             |
...
| Takealot Black Friday        | OOH-only: R320k planning budget with explicit source-controlled flexibility to R400k; JHB/CPT/DBN; Mall of Africa, Sandton City, Gateway, Cavendish and Menlyn; digital mega boards and digital 6x3 only; no static; Nov 4-28 with final three-week interpretation confirmed from source; rotating animation and urgent proposal deadline. | Same canonical STP/planning stages as full campaign, only OOH/DOOH selected, POI/format/date/budget validation, current supply, explicit VAT and branded proposal; an equivalent complete signed mailbox request sends once without per-request input |
...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| Product journeys        | Discovery/unbriefed, supplied-brief full campaign and canonical OOH-only campaign mode; proposal, funding, booking, creative, delivery, proof and reporting                                          | Sections 7, 19, 24 and E2E-02/03/04/07/08                   |
