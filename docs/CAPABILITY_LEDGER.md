...
| 11 Campaign delivery and learning | IN PROGRESS — funding governance and Campaign `PLANNED` to `BOOKED` readiness are verified locally; creative, live delivery, proof, measurement and learning remain unimplemented |
